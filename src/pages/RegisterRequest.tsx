      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          ...
          <div>
            ...
            <input id="reg-posto" type="text" autoComplete="organization" enterKeyHint="done" className="w-full h-11 border border-border-gray rounded-none px-3 bg-white/80 focus:ring-1 focus:ring-navy focus:outline-none transition-colors" value={formData.currentPost} onChange={e => setFormData({...formData, currentPost: e.target.value})} />
          </div>
        </div>
        <Button
          type="submit"
