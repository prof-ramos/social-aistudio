  ...
  return (
    <PageContainer variant="feed" className="space-y-8">
      ...
      <div className="bg-white border border-border-gray shadow-sm overflow-hidden">
        <Table>
          <TableHeader>
            <TableRow className="bg-ice border-b border-border-gray text-navy hover:bg-ice">
              <TableHead className="py-4 px-6 font-semibold text-base text-navy">Nome / E-mail</TableHead>
              <TableHead className="py-4 px-6 font-semibold text-base text-navy">Matrícula / CPF</TableHead>
              <TableHead className="py-4 px-6 font-semibold text-base text-navy">Categoria</TableHead>
              <TableHead className="py-4 px-6 font-semibold text-base text-navy">Posto</TableHead>
              <TableHead className="py-4 px-6 font-semibold text-base text-navy">Status</TableHead>
              <TableHead className="py-4 px-6 font-semibold text-base text-navy">Ações</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {requests.length === 0 && (
            ...
            {requests.map(req => (
              <TableRow key={req.id} className="border-b border-border-gray hover:bg-ice/50 transition-colors">
                ...
                <TableCell className="py-4 px-6 text-base text-slate">
                  <p>{req.matricula}</p>
                ...
                <TableCell className="py-4 px-6 text-base text-slate">{req.currentPost || '-'}</TableCell>
                <TableCell className="py-4 px-6">
