    ...
    <div className="w-full lg:w-[280px] xl:w-[300px] flex-none flex flex-col gap-6 sticky top-24">
      ...
      <div className="bg-white border border-border-gray shadow-sm overflow-hidden">
        ...
        <div className="px-6 pb-6 relative">
          <Link to={`/perfil/${profile.id}`} className="block absolute -top-10 left-6 w-20 h-20 bg-ice border-4 border-white shadow-sm flex items-center justify-center font-bold text-2xl text-navy uppercase hover:opacity-90 transition-opacity">
            {profile.avatarUrl ? (
          ...
          <div className="mt-6 pt-4 border-t border-border-gray/50 flex gap-4 text-center">
