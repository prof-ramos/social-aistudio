...
export function Navbar({ profile, isAdminView }: { profile: UserProfile, isAdminView?: boolean }) {
  ...
  return (
    <>
      ...
      <nav
        className="sticky top-0 z-50 flex h-16 flex-none items-center justify-between border-b border-border-gray bg-white px-6 font-sans shadow-[0_1px_0_color-mix(in_srgb,var(--app-institutional-gold)_55%,transparent)] transition-[background-color,box-shadow,color] duration-200 md:bg-white/92 md:backdrop-blur-md md:px-8"
