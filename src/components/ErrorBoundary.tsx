          ...
          <div className="bg-white border-t-4 border-danger/80 shadow-sm max-w-lg w-full text-center p-10">
            ...
            {this.state.error && (
              <div className="mt-8 pt-6 border-t border-border-gray/50 text-left">
                <p className="text-sm uppercase font-bold text-slate/90 mb-2">Detalhes do Erro</p>
                <div className="bg-ice p-4 overflow-auto text-sm text-slate font-mono whitespace-pre-wrap max-h-32">
